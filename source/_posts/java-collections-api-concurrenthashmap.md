---
title: Java集合类之ConcurrentHashMap
date: 2020-03-06 17:15:13
tags: java collections api
categories: java
---

ConcurrentHashMap不允许任何记录的键或者值为null。
...
当桶为空时，putVal方法使用**CAS（Compare And Swap，比较并交换）算法**，由sun.misc.Unsafe类实现。
